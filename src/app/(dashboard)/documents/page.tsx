...
import { DocumentApprovalCoordinator } from '@/components/documents'
...
export default function DocumentsPage() {
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage documents and approval workflows for your construction projects
          </p>
        </div>
      </div>
      ...
      {/* Main Document Approval Coordinator */}
      <DocumentApprovalCoordinator />
    </div>
  )
}