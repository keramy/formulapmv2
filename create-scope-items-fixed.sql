-- Create Scope Items for Test Projects - FIXED VERSION
-- This adds scope items to make the dashboard statistics meaningful

-- Get project IDs and create scope items for Downtown Office Renovation
...
) AS items(category, description, quantity, unit_of_measure, unit_price, status, progress, priority);
