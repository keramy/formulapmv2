    ...
    async updateUserRoles() {
        ...
        const migrationQuery = `
            ...
            SET 
                previous_role = role,
                role = CASE 
                    WHEN role = 'management' THEN 'management'::user_role
                    WHEN role = 'management' THEN 'management'::user_role
                    WHEN role = 'management' THEN 'management'::user_role
                    WHEN role = 'technical_lead' THEN 'technical_lead'::user_role
                    WHEN role = 'project_manager' THEN 'project_manager'::user_role
                    WHEN role = 'project_manager' THEN 'project_manager'::user_role
                    WHEN role = 'project_manager' THEN 'project_manager'::user_role
                    WHEN role = 'purchase_manager' THEN 'purchase_manager'::user_role
                    WHEN role = 'purchase_manager' THEN 'purchase_manager'::user_role
                    WHEN role = 'project_manager' THEN 'project_manager'::user_role
                    WHEN role = 'project_manager' THEN 'project_manager'::user_role
                ...
                seniority_level = CASE 
                    WHEN role IN ('management', 'management') THEN 'executive'
                    WHEN role IN ('management', 'technical_lead', 'purchase_manager', 'project_manager') THEN 'senior'
                    ELSE 'regular'
                END,
