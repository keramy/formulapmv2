...
DO $$
BEGIN
  RAISE NOTICE 'SUCCESS: is_management_role function recreated successfully';
  RAISE NOTICE 'INFO: Function now queries user_profiles table instead of JWT token';
END $$;