...
-- Management widgets
('management', 'company_overview', 'metric', 1, 'large', '{"metrics": ["total_projects", "total_revenue", "active_users", "completion_rate"]}'),
('management', 'financial_summary', 'chart', 2, 'large', '{"chart_type": "mixed", "data_source": "financial_summary"}'),
('management', 'project_portfolio', 'list', 3, 'medium', '{"show_fields": ["name", "status", "budget", "progress"]}'),
...
-- Technical Lead widgets (replaces field worker)
('technical_lead', 'daily_tasks', 'list', 1, 'large', '{"filter": "today", "show_location": true}'),
('technical_lead', 'technical_review', 'form', 2, 'medium', '{"form_type": "technical_report", "allow_photos": true}'),
('technical_lead', 'drawing_approvals', 'list', 3, 'medium', '{"entity_types": ["shop_drawing"], "status": "technical_review"}'),

-- Purchase Manager widgets
('purchase_manager', 'procurement_overview', 'metric', 1, 'large', '{"metrics": ["active_orders", "pending_approvals", "vendor_performance"]}'),
('purchase_manager', 'vendor_performance', 'chart', 2, 'medium', '{"chart_type": "bar", "data_source": "vendor_metrics"}'),
...
-- Admin widgets
('admin', 'system_overview', 'metric', 1, 'large', '{"metrics": ["total_users", "active_projects", "system_health"]}'),
('admin', 'user_activity', 'chart', 2, 'medium', '{"chart_type": "line", "data_source": "user_activity"}');
