...
-- Insert default permission templates for all roles
...
}', 'Full system access for company owner'),

('general_manager', '{
  "projects": ["create", "read", "update", "archive"],
  "users": ["read", "update", "manage_assignments"],
  "finance": ["view_all", "approve_budgets"],
  "reports": ["view_all", "create_management", "export"],
  "suppliers": ["approve", "evaluate"]
