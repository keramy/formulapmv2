...
-- Generated: 2025-07-18 (Syntax Fixed)
...
-- ============================================================================
-- PERFORMANCE HELPER FUNCTIONS (FIXED SYNTAX)
-- ============================================================================
...
VALUES (
  'rls_performance_optimization_fixed', 
  'completed', 
  NOW(),
  'Fixed 15+ critical RLS performance issues by optimizing auth.<function>() calls - SYNTAX CORRECTED'
)
ON CONFLICT (migration_name) DO UPDATE SET 
  status = 'completed', 
  completed_at = NOW(),
  notes = 'Fixed 15+ critical RLS performance issues by optimizing auth.<function>() calls - SYNTAX CORRECTED';
