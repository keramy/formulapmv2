...
-- This resolves the 406 error when logging in with admin credentials

-- First, let's check what admin users exist in auth.users
-- You can run this to see all auth users:
-- SELECT id, email, created_at FROM auth.users;

-- Insert the admin profile for the authenticated user
-- The ID 'e42c6330-c382-4ba8-89c1-35895dddc523' is from your error log
INSERT INTO user_profiles (
  ...
  'management', -- Admin role for full access
  'Admin', 
  'User', 
